...
import { User as UserIcon, Shield, KeyRound, Settings } from "lucide-react";
...
export default function ProfilePage() {
  ...
  const initialChar = user.fullName?.charAt(0)?.toUpperCase() || user.username?.charAt(0)?.toUpperCase() || "U";
      ...
      <Card className="border-slate-100 shadow-md rounded-3xl overflow-hidden">
        <CardContent className="p-6 md:p-8">
          <Tabs defaultValue="info" className="space-y-8">
            ...
            <TabsContent value="security" className="outline-none focus:outline-none">
              <div className="mb-6">
